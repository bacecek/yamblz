...
public class WeatherRepositoryImpl implements WeatherRepository {
    ...
    public WeatherRepositoryImpl(Context context, WeatherApi api, RxSharedPreferences rxPreferences, SharedPreferences preferences) {
    ...
    public Single<WeatherResponse> getCurrentWeather(String city) {
        if(Utils.isOnline(mContext)) {
            return mApi.getCurrentWeather(city, mPreferences.getString(Consts.Prefs.KEY_UNITS, "metric"))
